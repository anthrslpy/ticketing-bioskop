...
public class ViewRegister extends javax.swing.JFrame {
    ...
    public ViewRegister(Film selectedFilm) {
        initComponents();   
    ...
    private void prosesRegistrasi() {                 
        ...
        Pengguna userBaru;
        if(valid){                            
            userBaru = new Penonton(id, username, email, password, phone);
            user = userBaru;                
            try (BufferedWriter writer = new BufferedWriter(new FileWriter("UsersData.txt", true))) {                
                writer.write(String.format("%s,%s,%s,%s,%s,%s\n", id, email, username, password, phone, "CUSTOMER"));                     
            } catch (IOException e) {
                JOptionPane.showMessageDialog(register, "Failed to save your data!");
            }             
        }      
    ...
    private String generateId() {
        return "USER" + (dataPengguna.size() + 1);
    }  
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Welcome to CINEMAXX!");
        ...
        fieldPhone.setPreferredSize(new java.awt.Dimension(64, 29));
                ...
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addGroup(jPanel1Layout.createSequentialGroup()
                            ...
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(fieldPhone, javax.swing.GroupLayout.PREFERRED_SIZE, 280, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGap(208, 208, 208)))
        );
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new ViewRegister(selectedFilm).setVisible(true);
            }
        });
    }
