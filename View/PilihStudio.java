...
public class PilihStudio extends javax.swing.JFrame {
    ...
    private List<Jadwal> regulerJadwals;
    private List<Jadwal> deluxeJadwals;
    ...
    private void updateFilmInfo() throws IOException {
        ...
        regulerJadwals = getJadwalByTipeStudio("Reguler");
        setJadwalButtons(regulerJadwals, new JButton[]{btnTime1Studio1, btnTime2Studio1, btnTime3Studio1}, "Reguler");

        deluxeJadwals = getJadwalByTipeStudio("Deluxe");
        setJadwalButtons(deluxeJadwals, new JButton[]{btnTime1Studio2, btnTime2Studio2}, "Deluxe");                
    }
    ...
    private void handleTimeButtonClick(String studioType, int index) {
        Jadwal selectedJadwal = null;
        
        if (studioType.equalsIgnoreCase("Reguler")) {
            if (index < regulerJadwals.size()) {
                selectedJadwal = regulerJadwals.get(index);
            }
        } else if (studioType.equalsIgnoreCase("Deluxe")) {
            if (index < deluxeJadwals.size()) {
                selectedJadwal = deluxeJadwals.get(index);
            }
        }
    ...
    private void btnTime1Studio1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTime1Studio1ActionPerformed
        handleTimeButtonClick("Reguler", 0);        
    ...
    private void btnTime3Studio1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTime3Studio1ActionPerformed
        handleTimeButtonClick("Reguler", 2);        
    ...
    private void btnTime1Studio2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTime1Studio2ActionPerformed
        handleTimeButtonClick("Deluxe", 0);        
    ...
    private void btnTime2Studio1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTime2Studio1ActionPerformed
        handleTimeButtonClick("Reguler", 1);        
    ...
    private void btnTime2Studio2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTime2Studio2ActionPerformed
        handleTimeButtonClick("Deluxe", 1);        
